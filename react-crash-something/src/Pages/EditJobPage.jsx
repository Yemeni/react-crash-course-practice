                    ...
                    <form onSubmit={submitForm}>
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                required
                                value={job.type}
                                onChange={(e) => updateJob({...job, type: e.target.value})}
                            >
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                required
                                value={job.salary}
                                onChange={(e) => updateJob({...job, salary: e.target.value})}
                            >
                        ...
                        <div className='mb-4'>
                            ...
                            <input
                                ...
                                required
                                value={job.location}
                                onChange={(e) => updateJob({...job, location: e.target.value})}
                            />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) => updateJob({...job, company_name: e.target.value})}
                            />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <textarea
                                ...
                                onChange={(e) => updateJob({...job, company_description: e.target.value})}
                            ></textarea>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) => updateJob({...job, contact_email: e.target.value})}
                            />
                        </div>
                        <div className="mb-4">
                            <label
                            ...
                            <input
                                ...
                                onChange={(e) => updateJob({...job, contact_phone: e.target.value})}
                            />
                        </div>
